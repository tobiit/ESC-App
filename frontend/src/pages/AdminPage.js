...
export function AdminPage({ user, onLogout }) {
    ...
    const pauseReveal = async () => {
        ...
        try {
            ...
            setMessage(`Reveal konnte nicht pausiert werden: ${err.message}`);
        }
    };
    const resumeReveal = async () => {
        ...
        try {
            ...
            setMessage(`Reveal konnte nicht fortgesetzt werden: ${err.message}`);
        }
    };
    const restartReveal = async () => {
        ...
        try {
            ...
            setMessage(`Reveal konnte nicht neu gestartet werden: ${err.message}`);
        }
    };
